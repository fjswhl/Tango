...
- (void)commonInit {
    ...
    valueLabel.font = [UIFont fontWithDescriptor:fontDescriptor size:50.0f];
    ...
    self.valueLabel.text = [self.numberFormatter stringFromNumber:[NSNumber numberWithInt:0]];
